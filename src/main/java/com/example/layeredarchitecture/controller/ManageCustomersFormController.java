...
//
           ...
           // CustomerDaoImpl customerDaoImpl = new CustomerDaoImpl();  //Tight Coupling
...
//                pstm.executeUpdate();
           ...
           //   CustomerDaoImpl customerDaoImpl = new CustomerDaoImpl();  //Tight Coupling
                ...
                if (customerDao.saveCustomers(new CustomerDTO(id,name,address))){
                    new Alert(Alert.AlertType.CONFIRMATION,"Save Customer SuccsessFully");
                }
...
//                pstm.executeUpdate();
              ...
              //  CustomerDaoImpl customerDaoImpl = new CustomerDaoImpl();   //Tight Coupling
                ...
                if (customerDao.updateCustomer(new CustomerDTO(id,name,address))){
                       new Alert(Alert.AlertType.CONFIRMATION,"Update Customer SucessFully").show();
                }
...
//        pstm.setString(1, id);
     ...
     //   CustomerDaoImpl customerDaoImpl = new CustomerDaoImpl();    //Tight Coupling
        ...
        return  customerDao.customerExit(id);
    }
...
//            pstm.executeUpdate();
            ...
            if (customerDao.deleteCustomer(id)){
                new Alert(Alert.AlertType.CONFIRMATION,"Delete Sucsessfully").show();
            } else {
                new Alert(Alert.AlertType.CONFIRMATION,"Faild delete Customer").show();
            }
...
//            }
           // CustomerDaoImpl customerDaoImpl = new CustomerDaoImpl();    //Tight Coupling
            ...
            String currentId = customerDao.genarateId();
