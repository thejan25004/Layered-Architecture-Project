...
//            pstm.executeUpdate();
          ...
          //  ItemDaoImpl itemDaoImpl = new ItemDaoImpl();
            ...
            if (itemDao.deleteItem(code)){
                ...
                new Alert(Alert.AlertType.CONFIRMATION,"Delete Faild").show();
            }
...
//                pstm.executeUpdate();
               ...
               // ItemDaoImpl itemDaoImpl = new ItemDaoImpl();
                ...
                if (itemDao.saveItem(new ItemDTO(code,description,unitPrice,qtyOnHand))){
                    new Alert(Alert.AlertType.CONFIRMATION,"Save SucsessFully").show();
                } else {
                    new Alert(Alert.AlertType.CONFIRMATION,"Save Faild").show();
                }
...
//                pstm.executeUpdate();
              ...
              //  ItemDaoImpl itemDaoImpl = new ItemDaoImpl();
                ...
                if (itemDao.updateItems(new ItemDTO(code,description,unitPrice,qtyOnHand))){
                    new Alert(Alert.AlertType.CONFIRMATION,"Update Sucsessfully").show();
                } else {
                    new Alert(Alert.AlertType.CONFIRMATION,"Update Faild").show();
                }
